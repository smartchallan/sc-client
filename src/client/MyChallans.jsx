...
export default function MyChallans({ initialFilter = null, showClientPages = false }) {
  ...
  return (
    <div className="my-challans-content">
      ...
      <p className="page-subtitle">
        {showClientPages 
          ? "Select a client to view their vehicle challans" 
          : "View and manage your pending vehicle challans"
        }
      </p>
